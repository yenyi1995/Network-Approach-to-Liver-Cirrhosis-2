...
figure(2)
subplot (1,2,2)
plot(P4BRgraph,'Layout','force','UseGravity',true,'NodeColor','red','EdgeColor','black','MarkerSize',4)
%'LineWidth',LWidths,
...
figure(3)
subplot (1,2,2)
plot(P6BRgraph,'Layout','force','UseGravity',true,'NodeColor','red','EdgeColor','black','MarkerSize',4)
%'LineWidth',LWidths,
